# Join fan-out, CTE materialization and wrong cardinality

## Symptom
A finance query joins order headers, lines, promotion allocations and audit/outbox history. Runtime jumps from 2s to 35-45s for one hot seller although row counts look moderate.
...
## Evidence to capture
Primary signals: Nested Loop/Hash Join loops, Rows Removed by Join Filter, estimate-vs-actual ratio, shared hit/read buffers and materialized CTE time.
