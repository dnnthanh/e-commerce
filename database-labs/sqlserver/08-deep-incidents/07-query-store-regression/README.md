# Query Store plan regression and controlled forcing

## Symptom
A deployment changes cardinality behavior and a previously stable query regresses. Operators need evidence before forcing a plan.
...
## Evidence to capture
Primary signals: Query Store runtime intervals, plan_id comparison, wait categories, forced-plan failures and rollback criteria.
