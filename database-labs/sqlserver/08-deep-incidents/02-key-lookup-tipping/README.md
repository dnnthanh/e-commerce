# Key Lookup tipping point and covering-index budget

## Symptom
An index seek looks cheap but executes hundreds of thousands of Key Lookups to fetch wide columns; optimizer sometimes flips to a scan.
...
## Evidence to capture
Primary signals: Key Lookup executions, logical reads, lookup percentage, INCLUDE width and DML/index maintenance cost.
