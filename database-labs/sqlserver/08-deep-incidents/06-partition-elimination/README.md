# Partition elimination and aligned indexes

## Symptom
A date-partitioned order history query hides the partition key in CONVERT and scans partitions; non-aligned indexes make switching expensive.
...
## Evidence to capture
Primary signals: Actual Partitions Accessed, partition range operator, aligned index status and partition-switch prerequisites.
