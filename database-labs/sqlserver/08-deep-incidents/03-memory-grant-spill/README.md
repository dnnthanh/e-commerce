# Memory grants, sort/hash spill and feedback

## Symptom
A reconciliation hash join receives too small a grant and spills to tempdb; another parameter receives an excessive grant and starves concurrency.
...
## Evidence to capture
Primary signals: GrantedMemoryKb, UsedMemoryKb, spill warnings, tempdb IO, memory grant feedback and concurrent requests.
