# Deadlock graph, lock escalation and access ordering

## Symptom
Bulk order updates and line updates acquire objects in opposite order. Large batches also cross lock escalation thresholds.
...
## Evidence to capture
Primary signals: Extended Event deadlock XML, resource order, lock escalation, batch size and isolation hints.
