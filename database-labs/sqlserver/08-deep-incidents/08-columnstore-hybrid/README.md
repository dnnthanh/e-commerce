# Rowstore/columnstore hybrid for operational analytics

## Symptom
Settlement analytics scans tens of millions of immutable ledger rows while OLTP still needs point lookups and recent-row updates.
...
## Evidence to capture
Primary signals: batch mode, rowgroup quality, deleted rows, segment elimination and operational analytics trade-offs.
