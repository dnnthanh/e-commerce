# Snapshot isolation version store and tempdb pressure

## Symptom
Long-running reports under RCSI keep row versions while OLTP updates continue, causing tempdb growth and IO latency.
...
## Evidence to capture
Primary signals: version_store_reserved_page_count, longest snapshot, tempdb files, PAGELATCH vs IO waits and cleanup rate.
