# Partition pruning plus local/global index maintenance

## Symptom
Monthly settlement partitions support retention and period queries, but a global index becomes unusable/expensive during partition maintenance.
...
## Evidence to capture
Primary signals: PSTART/PSTOP, local/global index status, partition-wise operations and DROP/TRUNCATE partition maintenance cost.
