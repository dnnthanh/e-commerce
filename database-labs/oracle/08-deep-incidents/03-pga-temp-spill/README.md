# PGA workarea sizing and TEMP spill

## Symptom
A reconciliation query performs hash joins and sorts larger than workarea memory, creating multi-pass TEMP IO.
...
## Evidence to capture
Primary signals: V$SQL_WORKAREA onepass/multipass, tempseg usage, PGA target pressure, actual memory and concurrent-session budget.
