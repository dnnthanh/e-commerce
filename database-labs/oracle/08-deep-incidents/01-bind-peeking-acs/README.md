# Bind peeking, skew and adaptive cursor sharing

## Symptom
Settlement history is selective for most sellers but one seller owns a huge share. A cursor compiled for one bind performs badly for another.
...
## Evidence to capture
Primary signals: peeked binds, child cursors, bind-sensitive/bind-aware flags, A-Rows/E-Rows and buffer gets.
