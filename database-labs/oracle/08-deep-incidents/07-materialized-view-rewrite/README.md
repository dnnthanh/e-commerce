...
## Symptom
Settlement dashboards repeatedly aggregate immutable ledger data. A materialized view can help, but refresh mode and staleness rules determine correctness.
...
## Evidence to capture
Primary signals: query rewrite usage, refresh cost, staleness, fast-refresh eligibility and MV log write overhead.
