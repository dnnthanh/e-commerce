# SKIP LOCKED work queue fairness and hot blocks

## Symptom
Multiple workers claim operational tasks using FOR UPDATE SKIP LOCKED. Throughput is high initially but hot index/table blocks and unfair retry patterns appear.
...
## Evidence to capture
Primary signals: enq: TX waits, buffer busy/hot blocks, batch size, commit frequency and starvation detection.
