# UNDO retention and ORA-01555 snapshot too old

## Symptom
A long finance report competes with heavy OLTP updates. Required old versions are overwritten before the report finishes.
...
## Evidence to capture
Primary signals: V$UNDOSTAT tuned_undoretention, ssolderrcnt, maxquerylen, undo tablespace pressure and transaction duration.
