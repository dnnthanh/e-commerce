# Undo history, purge lag and long transactions

## Symptom
A forgotten read transaction prevents purge while high-write inventory tables accumulate undo. History list grows and consistent reads get slower.
...
## Evidence to capture
Primary signals: INNODB_TRX age, history list length, purge progress, undo tablespace growth and long-running snapshots.
