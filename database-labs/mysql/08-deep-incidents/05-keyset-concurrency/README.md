# Deep pagination and concurrent inserts

## Symptom
An activity feed uses LIMIT 100 OFFSET 500000 ordered by created_at. Latency grows linearly and same timestamps cause instability.
...
## Evidence to capture
Primary signals: rows examined per page, filesort avoidance, composite cursor (created_at,id), consistency during concurrent insert.
