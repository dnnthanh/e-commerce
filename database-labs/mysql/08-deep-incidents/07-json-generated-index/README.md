# JSON generated columns and selective indexing

## Symptom
Product attributes live in JSON. JSON_EXTRACT predicates scan widely and a naive generated column per attribute becomes unmaintainable.
...
## Evidence to capture
Primary signals: functional/generated-column index use, histogram selectivity, write amplification and JSON path compatibility.
