# Filesort, temporary tables and memory limits

## Symptom
A seller leaderboard groups and orders millions of rows. Internal temp tables spill and filesort dominates elapsed time.
...
## Evidence to capture
Primary signals: using temporary/filesort, sort_merge_passes, created_tmp_disk_tables, tmp_table_size/max_heap_table_size and concurrency memory budget.
