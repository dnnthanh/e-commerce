package com.dnnthanh.marketplace.be.operations.outbox.publisher;
...
/**
 * Independently scalable operations outbox publisher. Business transactions only persist durable
 * rows; this process owns Kafka network I/O.
 */
@Adapter
@RequiredArgsConstructor
public class OperationsOutboxPublisher {
